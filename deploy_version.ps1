...
try {
    ...
    & $git add content.json CHANGELOG.md index.html config.json index.js index.css blog.json translations_template.csv favicon.png favicon.ico pause-and-move-classic-massage.html admin.html start_preview.ps1 sitemap.xml BingSiteAuth.xml journal/ generate_blog.ps1 michael-guralnik.jpg
